            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input class="form-control data" type="password" name="password" autocomplete="off"
                                           value="">
                                </div>
                            </div>
                            <div class="clearfix"></div>
                    ...
                    <div class="alert-block">
                        <div class="alert-config-success alert alert-success alert-dismissible" style="display: none"
                             role="alert">
